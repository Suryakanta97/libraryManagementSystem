...
<div id="top-nav" class="navbar navbar-inverse navbar-static-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">EDUCART Dashboard</a>
        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content" id="viewBooksContent">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title" id="viewbooksmodalid">List of all the books in EDUCART</h4>
                            </div>
                            <div class="modal-body">
...
<footer class="text-center">Credits: This Bootstrap 3 dashboard layout is compliments of <a
        href="http://www.suryakanta97@gmail.com/"><strong>Suryakanta Sahoo</strong></a></footer>
